"""
http://xpaperchallenge.org/cv/survey/cvpr2020_summaries/311  
from https://github.com/YanchaoYang/FDA
...
if __name__ == "__main__":
  ...
  print(type(src_in_trg))
  cv2.imwrite("demo_images/src_in_tar.png",src_in_trg)
